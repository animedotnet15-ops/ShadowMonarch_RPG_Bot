...
ACHIEVEMENTS: dict[str, dict] = {
    "first_levelup":        {"name": "🆙 First Steps", "desc": "Reach Level 2", "title": "Novice"},
    "first_gate_win":       {"name": "🚪 Gate Breaker", "desc": "Win your first Gate battle", "title": "Gate Breaker"},
    "first_pvp_win":        {"name": "⚔️ Duelist", "desc": "Win your first PvP duel", "title": "Duelist"},
    "first_wildgate":       {"name": "🌀 Team Player", "desc": "Help defeat a Wild Gate", "title": "Team Player"},
    "rank_c":                {"name": "🎖️ Rising Hunter", "desc": "Reach Rank C", "title": "Rising Hunter"},
    "rank_s":                {"name": "👑 S-Rank Hunter", "desc": "Reach Rank S", "title": "S-Rank Hunter"},
    "guild_member":          {"name": "🏯 Guild Member", "desc": "Join a guild", "title": "Guildmate"},
    "daily_streak_7":        {"name": "🔥 Dedicated", "desc": "Reach a 7-day login streak", "title": "Dedicated"},
    "legendary_character":   {"name": "✨ Legendary Collector", "desc": "Own a Legendary (or higher) character", "title": "Collector"},
    "wealthy":               {"name": "💰 Wealthy Hunter", "desc": "Accumulate 5000 gold", "title": "Wealthy Hunter"},
}

# ------------------------------------------------------------------ #
#  Referral, Rob, Slots, Bank
# ------------------------------------------------------------------ #
REFERRAL_REWARD_GOLD = 100
ROB_COOLDOWN_SECONDS = 1800
ROB_SUCCESS_CHANCE = 0.5
ROB_STEAL_PERCENT = 0.15
ROB_MAX_STEAL = 300
ROB_FAIL_FINE = 50
SLOTS_COST_GOLD = 30
BANK_DAILY_INTEREST = 0.02  # 2% per day on banked gold
